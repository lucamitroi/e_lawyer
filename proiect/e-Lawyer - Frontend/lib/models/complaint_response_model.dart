...
complaint_response_model complaintResponseJson(String str) =>
    complaint_response_model.fromJson(json.decode(str));

class complaint_response_model {
  String? message;
  Data? data;

  complaint_response_model({required this.message, required this.data});

  complaint_response_model.fromJson(Map<String, dynamic> json) {
